<div class="page-wrapper">
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12">
                <h4 class="page-title">Detail Kartu Inventaris Bangunan dan Gedung</h4>
            </div>
        </div>
    </div>
                            ...
                            <div class="row col-md-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?= $bangunan->barang->nama_barang ?>" type="text" class="form-control" name="nama_barang" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row col-md-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?= $bangunan->barang->register_barang ?>" type="text" class="form-control" name="register_barang">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row col-md-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?= $bangunan->luaslantai_bangunan ?>" type="number" class="form-control" name="luaslantai_bangunan">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="recipient-name" class="control-label">Letak / Alamat</label>
                                        <input disabled value="<?= $bangunan->letak_bangunan ?>" type="text" class="form-control" name="letak_bangunan">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row col-md-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?= $bangunan->dokumentanggal_bangunan ?>" type="date" class="form-control" name="dokumentanggal_bangunan">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="recipient-name" class="control-label">Nomor Dokumen Gedung</label>
                                        <input disabled value="<?= $bangunan->dokumenno_bangunan ?>" type="text" class="form-control" name="dokumenno_bangunan">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row col-md-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?= $bangunan->luastanah_bangunan ?>" type="number" class="form-control" name="luastanah_bangunan">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="recipient-name" class="control-label">Status Tanah</label>
                                        <input disabled value="<?= $bangunan->statustanah_bangunan ?>" type="text" class="form-control" name="statustanah_bangunan">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row col-md-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?= $bangunan->nomor_bangunan ?>" type="text" class="form-control" name="nomor_bangunan">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="recipient-name" class="control-label">Asal Usul Tanah</label>
                                        <input disabled value="<?= $bangunan->asal_bangunan ?>" type="text" class="form-control" name="asal_bangunan">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row col-md-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled value="<?= $bangunan->harga_bangunan ?>" type="number" class="form-control" name="harga_bangunan">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="recipient-name" class="control-label">Keterangan</label>
                                        <input disabled value="<?= $bangunan->barang->keterangan_barang ?>" type="text" class="form-control" name="keterangan_barang">
                                    </div>
                                </div>
                            </div>                           
                        </form>
